...
```{r, data_viz_IQ_hist, fig.show="hold"}
...
```{r, data_viz_SI_hist, fig.show="hold"}
...
The Stan code was run using \verb|rstan| with 4 chains, 4000 iterations and with warm up length 2000. The final results were generated by running the code on \verb|https://jupyter.cs.aalto.fi/| servers.
...
towards the middle. These results satisfactory taking into account
